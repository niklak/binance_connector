//go:generate go run internal/cmd/genalias/genalias.go  --src=api/account,api/market,api/spot,api/wallet,api/staking,api/subaccount --dst-alias=connector_alias.go --dst-service=connector_service.go
